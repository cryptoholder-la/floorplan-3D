        ...
        <div className="max-w-6xl mx-auto px-6 py-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-white/60">Professional tools with 10_10 migration & AI integration</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <nav className="flex flex-wrap gap-2 justify-start sm:justify-end text-xs">
              ...
              <Link 
                href="/migrated-10-10"
                className="px-3 py-1 rounded-full border border-amber-400/40 text-amber-200 transition hover:bg-amber-400/10"
              >
                10_10 Migrated
              </Link>
            </nav>
        ...
        <div className="relative container mx-auto px-6 py-24">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              Now with migrated 10_10 design system and AI-powered tools.
            </p>
          ...
          <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-2xl p-8 border border-slate-700">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              ...
              >
                ...
                <h3 className="text-white font-semibold">10_10 System</h3>
                <p className="text-gray-400 text-sm mt-2">Migrated design system</p>
              </Link>
            </div>
          </div>
        </section>
      ...
      <footer className="border-t border-slate-700 py-8">
        <div className="container mx-auto px-6 text-center">
          <p className="text-gray-400">
            Floorplan 3D Design Suite - Powered by 10_10 Design System Migration & Memlayer AI
          </p>
