        ...
        <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-2xl p-8 border border-slate-700">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            >
              ...
              <h3 className="text-white font-semibold">Floorplan Builder</h3>
              <p className="text-gray-400 text-sm mt-1">2D to 3D conversion</p>
            </Link>
            ...
            >
              ...
              <h3 className="text-white font-semibold">Cabinet Library</h3>
