  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        position === "popper" &&
          "data-[side=bottom]:translate-y-1 data-[side=left]:translate-x-1 data-[side=right]:translate-x-1 data-[side=top]:translate-y-1 data-[side=bottom]:translate-y-1",
        className
      )}
      position={position}
      {...props}
    >
      ...
      >
        <ScrollArea className={cn("h-[var(--radix-select-trigger-height)] w-full")}>
          {children}
        </ScrollArea>
      </SelectPrimitive.Viewport>
    </SelectPrimitive.Content>
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("py-1.5 pl-8 text-sm font-semibold leading-none peer-disabled:cursor-not-allowed", className)}
    {...props}
  />
))
